...
| dompurify | 3.4.12 | (MPL-2.0 OR Apache-2.0) | transitive via mermaid | Yes; runtime dependency tree for Mermaid rendering | No | Use Apache-2.0 license path; keep notice/attribution; no source availability obligation for MornDraft code under Apache path | Approved | node_modules/dompurify/LICENSE; npm explain dompurify |
